...
DIMENSION_LINEAR::DIMENSION_LINEAR( BOARD_ITEM* aParent ) :
    BOARD_ITEM( aParent, PCB_DIMENSION_LINEAR_T ),
...
void DIMENSION_LINEAR::SetPosition( const wxPoint& aPos )
{
    m_Text.SetTextPosition( aPos );
}


const wxPoint& DIMENSION_LINEAR::GetPosition() const
{
    return m_Text.GetTextPosition();
}


void DIMENSION_LINEAR::SetText( const wxString& aNewText )
{
    m_Text.SetText( aNewText );
}


const wxString DIMENSION_LINEAR::GetText() const
{
    return m_Text.GetText();
}


void DIMENSION_LINEAR::SetLayer( LAYER_ID aLayer )
{
    m_Layer = aLayer;
